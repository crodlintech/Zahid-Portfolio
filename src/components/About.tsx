...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="relative py-28 md:py-40 px-6 md:px-12">
      {/* Subtle divider */}
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            >
              <span className="text-xs uppercase tracking-[0.35em] text-black/35 font-light">Story</span>
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold leading-tight text-black">
                Where Words Begin
                <br />
                <span className="text-black/35 font-light italic">to Mean Something</span>
              </h2>

              {/* SVG Writing Illustration */}
              <div className="mt-6 rounded-2xl overflow-hidden border border-black/[0.07] bg-white shadow-sm">
              ...
              {/* Tags */}
              <div className="p-5 bg-black/[0.02] border border-black/[0.07] rounded-2xl">
                <div className="flex flex-col gap-3">
                  {["Storytelling", "SEO Strategy", "Brand Voice", "AI Platforms", "Healthcare"].map((tag) => (
                    <div key={tag} className="flex items-center gap-3">
                      <div className="w-1 h-1 rounded-full bg-black/30" />
                      <span className="text-sm text-black/50 font-light">{tag}</span>
                    </div>
                  ))}
                </div>
              </div>
